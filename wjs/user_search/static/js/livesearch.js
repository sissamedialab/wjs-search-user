...
//		document.getElementById('livesearch').attachEvent("onblur",liveSearchHide,false);
	...
	// Kick an initial search when the field is already filled
	liveSearchDoSearch();
}
...
function liveSearchHide() {
	...
	if (highlight) {
		...
		highlight.firstChild.removeAttribute("checked");
	}
}
...
function liveSearchKeyPress(event) {
	...
	//KEY DOWN
	{
		...
		if (highlight) {
			...
			highlight.firstChild.setAttribute("checked","checked");
		}
